...
Rectangle {
    ...
    color: isDragOver ? (FluentTheme.isDark ? "#2A3548" : "#D8EEFB") : (mouseArea.containsMouse ? FluentTheme.bgCardHover : FluentTheme.bgCard)
    ...
    Column {
        ...
        Rectangle {
            ...
            height: 56
            radius: 28
            color: root.isDragOver ? FluentTheme.accent : (FluentTheme.isDark ? "#341C26" : "#EAF6FF")
