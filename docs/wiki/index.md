...
- [[arayuz-katmani]] — QML Windows 11 Fluent Split-View, AppBridge, ThemeManager, worker thread.
...
- [[teknoloji-yigini]] — PySide6/Pillow/PyInstaller/pytest, requirements dosya ayrımı, logging.
- [[build-ve-dagitim]] — build.bat (PyInstaller), Inno Setup script'i, repo hijyeni (exe geçmişten temizlendi).
...
Conventor, PySide6 + Pillow tabanlı bir masaüstü uygulaması: resim formatı dönüştürme (JPEG/PNG/WEBP/BMP/ICO/TIFF/SVG), piksel/yüzde bazlı yeniden boyutlandırma, LANCZOS+UnsharpMask ile çözünürlük artırma. PyInstaller ile tek dosya exe'ye derlenip Inno Setup ile paketleniyor.
