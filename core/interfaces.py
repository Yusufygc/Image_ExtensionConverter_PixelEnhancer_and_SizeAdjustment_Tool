...
class IConverter(IImageProcessor):
    ...
    def convert(self, image_path: str, output_format: str, output_path: str = None, output_dir: str = None) -> str:
        ...
        Args:
            ...
            output_dir: Optional output directory (used when output_path is not given).
        Returns:
...
class IResizer(IImageProcessor):
    ...
    """
    @abstractmethod
    def resize_by_dimensions(self, image_path: str, width: int, height: int, output_dir: str = None) -> Any:
        pass

    @abstractmethod
    def resize_by_percentage(self, image_path: str, percentage: int, output_dir: str = None) -> Any:
        pass
...
class IEnhancer(IImageProcessor):
    ...
    """
    @abstractmethod
    def enhance_resolution(self, image_path: str, factor: float, output_dir: str = None) -> Any:
        pass
